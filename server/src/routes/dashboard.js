...
router.get('/consultant', async (req, res) => {
  try {
    ...
    const calcComm = (sales) => calcCommission(consultant.payType, consultant.commissionRate, consultant.tierThreshold, consultant.tierRate, sales);
...
router.get('/', requireAdmin, async (req, res) => {
  try {
    ...
    // ---- CONSULTANT IMPACT ----
    const calcComm = (c, cSales) => calcCommission(c.payType, c.commissionRate, c.tierThreshold, c.tierRate, cSales);
